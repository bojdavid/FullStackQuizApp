<script lang="ts">
  ...
  const mockQuizzes: Quiz[] = [
    ...
    },
    {
      ...
      description:
        "Closures, prototypes, and asynchronous programming quiz from your lecture notes.",
...
<div class="p-6 lg:p-10 space-y-12 max-w-[1400px] mx-auto" in:fade>
  <!-- Header Section -->
  <header>
    <h1 class="text-4xl font-extrabold text-gradient mb-2 tracking-tight">
      Resources & Quizzes
    </h1>
    <p class="text-muted-foreground text-lg">
      Manage your study materials and track your quiz performance.
    </p>
  </header>
  ...
  <div class="flex flex-col gap-10">
    ...
    <aside class="space-y-10 max-w-5xl mx-auto">
      <AttemptHistory attempts={mockHistory} />

      <!-- Quick Stats / Secondary Card -->
      <div
        class="glass-card p-6 rounded-3xl bg-primary/5 border border-primary/20 max-w-lg mx-auto"
      >
