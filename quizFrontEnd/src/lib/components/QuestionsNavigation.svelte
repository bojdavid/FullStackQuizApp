<script>
    ...
    let {questions, questionNum, goToQuestion} = $props();
...
<div class="flex justify-start flex-wrap">
    ...
    {#if isViewNavs}
        {#each answeredQuestions as question}
            <button class="rounded-full w-13 h-13 text-lg font-bold {question.isAnswered? "bg-primary-500" : "bg-secondary-500"} text-center m-2 
